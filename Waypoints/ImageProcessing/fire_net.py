...
def train_detection_model():
    ...
    trainer.setDataDirectory(data_directory=os.path.join(execution_path, "fire-dataset"))
    print(os.path.join(execution_path, "fire-dataset"))
    trainer.setTrainConfig(object_names_array=["fire"], batch_size=8, num_experiments=100,
                           train_from_pretrained_model="pretrained-yolov3.pt")
