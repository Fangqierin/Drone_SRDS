...
Outputfile=f"result/result_2021/{file_name}_{checking_slot}_{Drone_Num}_{va}_{policy}_{par}.txt"
Drone_N=3
D=[5,15]    
Record_flag=True
faces=7
            ...
            for i in range(-1,0):
                ...
                for j in [10]:#range(14):  
                    ...
                    while done==False:
                        ...
                        t_l=time.time()
                        update,Replan,Table,cu_time,ww,enter_monitor,done=c.track(Sim_real,P_list,time_slot,logfile,checking_slot,Wap_dic,start_sim) # here check_slot=1 s
